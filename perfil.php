                            ...
                            <div class="col-6">
                                <div class="infoTudo-barbeiro">
                                    <div class="info-barbeiro">
                                        <h2><?php if (isset($row["nomeFantasia"])) {
                                                echo $row["nomeFantasia"];
                                            } else {
                                                echo $nome;
                                            }; ?></h2>
                                        <h5><?php if (isset($row["nomeFantasia"])) {
                                                echo $nome;
                                            } ?></h5>
                                        <p><?php if (isset($row["nomeFantasia"])) {
                                                echo $row["rua"] . " Nº " . $row["numero"] . ", " . $row["bairro"] . ", " . $row["cidade"];
                                            } ?></p>
                                    </div>
                ...
                ORDER BY data ASC, horario ASC";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $nomeAgenda = $row["nome"];
                                            $nomeAgenda = $row["nome"];
                                            $nomeAgenda = strtolower($nomeAgenda);
                                            $nomeAgenda = ucwords($nomeAgenda);
