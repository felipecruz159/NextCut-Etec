            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="content-carreira">
                    ...
                    <i class="bi bi-people-fill"></i>
                        <h4>Equipe Nota 1000</h4>
                        <p>Em todos os sentidos.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="content-carreira">
                    ...
                    <i class="bi bi-check2"></i>
                        <h4>Excelência</h4>
                        <p>Na entrega de nosso melhor, sempre.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="content-carreira">
                    ...
                    <i class="bi bi-heart"></i>
                        <h4>Compromisso com parceiros</h4>
                        <p>Ponto de partida de nossos trabalhos.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                <div class="content-carreira">
                    ...
                    <i class="bi bi-person-hearts"></i>
                        <h4>Ética e Respeito</h4>
                        <p>Um vínculo levado a sério.</p>
                    </div>
                </div>
            </div>
        </div>
